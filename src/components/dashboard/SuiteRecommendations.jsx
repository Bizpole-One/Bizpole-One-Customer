...
const recommended = [
  { title: "MSME / Udyam Registration", sub: "Unlock subsidies & faster loans", price: "₹ 1,499", note: "one-time" },
  { title: "Trademark – Logo Class", sub: "Protect your brand", price: "₹ 6,999", note: "+ govt fee" },
  { title: "Payroll & PF/ESI Setup", sub: "You added 2 employees", price: "₹ 2,499", note: "/ month" },
];
...
const news = [
  {
    ...
    title: "New e-invoicing threshold from 1 Aug",
    body: "Applies to turnover above ₹5 Cr — see if you're affected.",
  },
  {
    tag: "MCA",
    tagColor: "bg-amber-100 text-amber-700",
    title: "ROC filing dates extended",
    body: "AOC-4 deadline moved — your filing is already planned.",
  },
  {
    tag: "EVENT",
    tagColor: "bg-green-100 text-green-700",
    title: "Free webinar: Tax-saving for SMEs",
    body: "Thu 6 PM · Register in one click.",
  },
];
  ...
  <>
    ...
    <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-yellow-700 to-yellow-400 p-5 text-white">
        ...
        <h4 className="my-2 text-lg font-bold">Your turnover crossed ₹40L.</h4>
        <p className="mb-4 max-w-md text-[12.5px] leading-relaxed opacity-90">
    ...
    <div className="mt-4 grid grid-cols-1 gap-4 lg:grid-cols-2">
      ...
      <Card>
        ...
        <div>
          {news.map((n) => (
            <div key={n.title} className="flex gap-3 border-b border-gray-100 py-2.5 last:border-0">
              <span
                className={`h-max whitespace-nowrap rounded px-1.5 py-1 text-[9px] font-extrabold ${n.tagColor}`}
              >
                {n.tag}
              </span>
              <div>
